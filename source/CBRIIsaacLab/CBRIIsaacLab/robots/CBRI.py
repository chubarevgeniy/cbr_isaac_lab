...
CBR_I_CONFIG = ArticulationCfg(
    ...
    actuators={
        ...
        "coupled_leg_actuator": CoupledLegPDActuatorCfg(
            ...
            # torques while each motor remains limited to 6.0 N m.
            effort_limit=6.0,
            effort_limit_sim={
                "body_Revolute_4": 12.0,
                "body_Revolute_5": 12.0,
                "right_hip_Revolute_6": 6.0,
                "left_hip_Revolute_7": 6.0,
            },
            ...
            # Softer than the nominal gains by 30%.
            stiffness=51.31,
            damping=2.569,
        ),
    },
